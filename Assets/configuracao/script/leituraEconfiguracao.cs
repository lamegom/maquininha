...
public class leituraEconfiguracao : MonoBehaviour {
	...
	void Update () {
		...
		if(Application.loadedLevelName == "configuracaoMaquina"){
			...
			acum1[0].GetComponent<GUIText>().color = Color.white;
			acum2[0].GetComponent<GUIText>().color = Color.white;
			acum1[1].GetComponent<GUIText>().color = Color.white;
			acum2[1].GetComponent<GUIText>().color = Color.white;
			acum1[2].GetComponent<GUIText>().color = Color.white;
			acum2[2].GetComponent<GUIText>().color = Color.white;
			acum1[3].GetComponent<GUIText>().color = Color.white;
			acum2[3].GetComponent<GUIText>().color = Color.white;
			entradaTotal.GetComponent<GUIText>().color = Color.white;
			porcentagem.GetComponent<GUIText>().color = Color.white;
			previsao.GetComponent<GUIText>().color = Color.white;
			saidaTotal.GetComponent<GUIText>().color = Color.white;
			...
			if(cont == 0){
				acum1[0].GetComponent<GUIText>().color = Color.red;
				//ZERA
			...
			if(cont == 1){
				acum1[1].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
					bancoDados.MINIMO1();
			...
			if(cont == 2){
				acum1[2].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
			...
			if(cont == 3){
				acum1[3].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
			...
			if(cont == 4){
				acum2[0].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
					bancoDados.MAXIMO2();
			...
			//ACUMULADO MINIMO ABOBORAS 1
			if(cont == 5){
				acum2[1].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
					bancoDados.MINIMO2();
			...
			//ACUMULADO PORCETAGEM ABOBORA
			if(cont == 6){
				acum2[2].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
			...
			//ACUMULADO ATUAL ABOBORA
			if(cont == 7){
				acum2[3].GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.ConfiguraAcumuladoM1 = 0;
			...
			//pulso
			if(cont == 8){
				porcentagem.GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.pulso = 0;
			...
			//retencao
			if(cont == 9){
				previsao.GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
			...
			//entrada
			if(cont == 10){
				entradaTotal.GetComponent<GUIText>().color = Color.red;
				//ZERA
				if(Input.GetKeyDown(KeyCode.J)){
					bancoDados.pulso = 0;
		...
		if(Application.loadedLevelName == "testeInput"){
			if(Input.GetKeyDown(KeyCode.B)){
				if(valor > 1){
					acum2[3].GetComponent<GUIText>().enabled = false;
					acum2[2].text = "R$ 0";
					valor = 1;
				}
				else{
			...
			if(Input.GetKey(KeyCode.J)){
				saidaTotal.GetComponent<GUIText>().color = Color.red;
			}
			...
			if(Input.GetKey(KeyCode.N)){
				contabilidade.GetComponent<GUIText>().color = Color.red;
			}
			...
			if(Input.GetKeyDown(KeyCode.P)){
				...
				valor++;
				acum2[3].GetComponent<GUIText>().enabled = true;
			}
